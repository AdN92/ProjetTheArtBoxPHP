...
<body>
    ...
    <?php include('header.php'); ?>
     ...
     <!-- Inclusion Liste des oeuvres -->
     <?php include('oeuvres.php'); ?>

    <main>
        <!--Section de la Liste des oeuvres -->
        <div id="liste-oeuvres">
            <?php foreach ($oeuvres as $oeuvre): ?>
                <!--Début de la balise "article" pour chaque oeuvre -->  
                <article class="oeuvre">
                    <!-- Lien vers la page de détails de L'oeuvre en utilisant l'id comme paramètre GET -->
                        <a href="oeuvre.php?id=<?php echo $oeuvre['id']; ?>">
                        <!-- Affichage de l'image de l'oeuvre -->
                        <img src="<?php echo $oeuvre['image']?>" alt="<?php echo $oeuvre['alt'] ?>"></img>
                        <!-- Affichage du titre -->
